...
```
 ...
 School Search      Data Source Manager
        ...
        Excel / School Info / S2B / G2B / Education
...
See [Connector Framework](docs/CONNECTOR_FRAMEWORK.md) for lifecycle,
mock-source, registration, and future activation guidance.

See [School360 Dashboard](docs/SCHOOL360.md) for the integrated school view,
selection routes, mock-data sections, and connector boundaries.

See [School360 예정사업 관리](docs/PROJECT_MANAGEMENT.md) for manual project CRUD,
Excel bulk registration/update, accepted columns, and validation rules.
